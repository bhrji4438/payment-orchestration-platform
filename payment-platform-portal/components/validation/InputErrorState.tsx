...
export interface InputErrorStateProps extends InputHTMLAttributes<HTMLInputElement> {
  error?: string;
  isTouched?: boolean;
  isValid?: boolean;
}

export const InputErrorState = forwardRef<HTMLInputElement, InputErrorStateProps>(
...
InputErrorState.displayName = 'InputErrorState';
