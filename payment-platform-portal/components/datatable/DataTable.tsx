        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <form onSubmit={handleSearchSubmit} className="relative">
              ...
              <input
                type="text"
                className="block w-full sm:w-64 pl-10 pr-3 py-2 border border-zinc-800 rounded-lg leading-5 bg-zinc-950 text-zinc-300 placeholder-zinc-500 focus:outline-none focus:border-indigo-500 transition-colors sm:text-sm"
                placeholder="Search..."
                value={searchInput}
            ...
            <tr className="border-b border-zinc-800">
              ...
              {visibleColumns.map((column) => (
                <th
                  ...
                  scope="col"
                  className={`px-6 py-4 text-[10px] font-semibold text-zinc-500 uppercase tracking-wider ${column.align === 'right' ? 'text-right' : column.align === 'center' ? 'text-center' : 'text-left'} ${column.sortable ? 'cursor-pointer hover:text-zinc-300 transition-colors' : ''}`}
